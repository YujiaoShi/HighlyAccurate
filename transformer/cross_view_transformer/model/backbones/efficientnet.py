...
class EfficientNetExtractor(torch.nn.Module):
    ...
    def __init__(self, layer_names, image_height, image_width, model_name='efficientnet-b4'):
        ...
        # print(f'CWD: {Path.cwd()}')  #: /home/goroyeh/Yujiao/leekt/HighlyAccurate/outputs/2023-02-21/15-49-56
        net = EfficientNet.from_pretrained(
            model_name, weights_path="../../../transformer/cross_view_transformer/pretrained_models/efficientnet-b4-6ed6700e.pth")
        net.set_swish(False)
